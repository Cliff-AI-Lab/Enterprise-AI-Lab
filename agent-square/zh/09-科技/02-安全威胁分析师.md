...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| VirusTotal | https://www.virustotal.com/api/v3 | API Key免费 | 文件/URL/域名扫描 |
| AbuseIPDB | https://api.abuseipdb.com/api/v2 | API Key免费 | IP滥用情报 |
| Shodan | https://api.shodan.io | API Key | 互联网资产 |
| URLhaus | https://urlhaus-api.abuse.ch/v1 | 无需Key | 恶意URL |
