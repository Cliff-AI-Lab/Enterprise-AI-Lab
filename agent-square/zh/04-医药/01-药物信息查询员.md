...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| OpenFDA | https://api.fda.gov/drug | 无需Key (限频) | FDA药品数据 |
| RxNorm (NIH) | https://rxnav.nlm.nih.gov/REST | 无需Key | 标准药名映射 |
| DailyMed | https://dailymed.nlm.nih.gov/dailymed/services | 无需Key | 药品说明书 |
