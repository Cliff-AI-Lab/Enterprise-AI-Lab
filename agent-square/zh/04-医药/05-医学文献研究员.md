...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| PubMed E-Utils | https://eutils.ncbi.nlm.nih.gov/entrez/eutils | 无需Key | 文献检索 |
| CrossRef | https://api.crossref.org | 无需Key | DOI解析/元数据 |
| Europe PMC | https://www.ebi.ac.uk/europepmc/webservices | 无需Key | 全文可获 |
