...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| Nager.Date | https://date.nager.at/api/v3 | 无需Key | 公共假期 (排程规避) |
| Calendarific | https://calendarific.com/api/v2 | API Key免费 | 全球假日 |
| World Time API | http://worldtimeapi.org/api | 无需Key | 多时区协同 |
