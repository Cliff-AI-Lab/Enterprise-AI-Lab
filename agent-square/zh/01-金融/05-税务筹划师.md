...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| IRS Data API | https://www.irs.gov/pub/irs-soi | 无需Key | 美国税收数据 |
| ExchangeRate-API | https://api.exchangerate-api.com | 无需Key | 换算外币收入 |
| SEC EDGAR | https://data.sec.gov | 无需Key | 公司税务披露 |
