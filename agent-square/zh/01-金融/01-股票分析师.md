...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| Alpha Vantage | https://www.alphavantage.co/query | API Key (免费) | 实时股价、历史数据、技术指标 |
| Finnhub | https://finnhub.io/api/v1 | API Key (免费) | 公司新闻、财报、内部人交易 |
| Financial Modeling Prep | https://financialmodelingprep.com/api/v3 | API Key (免费250次/日) | 财务报表、DCF估值、股利 |
