...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| ExchangeRate-API | https://api.exchangerate-api.com/v4/latest/ | 无需Key | 实时汇率 |
| Frankfurter | https://api.frankfurter.app | 无需Key | 欧央行历史汇率 |
| Fixer.io | https://data.fixer.io/api/latest | API Key (免费100次/月) | 高精度汇率 |
