...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| CoinGecko | https://api.coingecko.com/api/v3 | 无需Key (免费10-50次/分) | 价格、市值、历史、交易所数据 |
| CoinCap | https://api.coincap.io/v2 | 无需Key | 实时行情、市场数据 |
| Blockchain.info | https://blockchain.info/api | 无需Key | BTC链上数据、交易查询 |
