...
| API | 地址 | 认证 | 用途 |
|-----|------|------|------|
| UK Trade Tariff | https://www.trade-tariff.service.gov.uk/api | 无需Key | 英国HS税率 |
| ExchangeRate-API | https://api.exchangerate-api.com | 无需Key | 关税折算 |
| RestCountries | https://restcountries.com/v3.1 | 无需Key | 贸易协定国信息 |
